/*
    decbin.c
    Este programa converte um numero expresso em base decimal para seu equivalente em
    base binaria
    ...
    Concatenando o ultimo quociente com todos os restos em ordem inversa temos:
    59 (dec) = 111011 (bin)
